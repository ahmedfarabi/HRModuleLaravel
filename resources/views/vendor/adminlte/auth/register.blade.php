                ...
                <form action="{{ url('/register') }}" method="post">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
            		 ...
            		 <div class="form-group has-feedback">
                        ...
                        <select class="form-control select2" id="employee_id" name="employee_id" data-placeholder="Employee ID" required >
             
                           <option value="" disabled selected hidden="">{{ trans('adminlte_lang::message.employee_id') }}</option>
	                         <?php $emps = DB::table('employees')->select('employee_id', 'full_name')->distinct()->get();
