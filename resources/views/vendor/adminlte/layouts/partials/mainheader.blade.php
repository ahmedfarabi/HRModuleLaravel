...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-lg"><b>ERP</b> Laravel </span>
    </a>
...
<!--                                     <small>{{ Auth::user()->company->company_name }}</small> -->
                                    <small>Employee ID : {{ Auth::user()->employee_id}}</small>
                                    <small>{{ trans('adminlte_lang::message.login') }} <?php echo ' - '.date(' F j, Y'); ?></small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
